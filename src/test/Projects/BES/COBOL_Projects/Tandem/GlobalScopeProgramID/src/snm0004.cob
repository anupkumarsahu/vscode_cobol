...
/
 ...
 01  dummy-rec                       PIC x(132).

****************************************************************************
* THE TABLE DATA
****************************************************************************
 01 SUB-1                               PIC 999 VALUE ZERO.
 01 SUB-2                               PIC 999 VALUE ZERO.
 01 THE-VAL                             PIC 999 VALUE ZERO.

 01 THE-TABLE.
    02 THE-ROW OCCURS 104 TIMES.
       03 THE-COLUMN OCCURS 104 TIMES.
          04 THE-ITEM                   PIC 999.
****************************************************************************
****************************************************************************
...
* ------------------------------
 ...
 01  print-header                   PIC X(37)
     VALUE IS "Start of COBOL INSPECT test C000COB4.".

 01  final-msg                      PIC X(25)
     VALUE  "Test C000COB4 terminated.".
...
/
 ...
 Big-number-processing.
      ...
      PERFORM Move-one-by-one THRU Move-one-by-one-exit.
...
/
 ...
 Abend.
*****************  this is a dummy paragraph heading   ***********************
...
/
 BUILD-TABLE.
     ADD 1 TO SUB-1.
     IF SUB-1 = 105 GO TO WRITE-TABLE.
 ...
 PUT-IN-ITEM.
     ...
     IF SUB-2 = 105
         ...
         GO TO BUILD-TABLE.
     ADD 1 TO THE-VAL.
     MOVE THE-VAL TO THE-ITEM (SUB-1, SUB-2).
     GO TO BUILD-TABLE.

 WRITE-TABLE.
     MOVE 1 TO SUB-1 SUB-2.
     PERFORM WRITE-ROW 104 TIMES.

 WRITE-ROW.
     STRING " ROW-" DELIMITED BY SIZE,
            THE-ITEM (SUB-1, SUB-2) DELIMITED BY SIZE,
            " COL-" DELIMITED BY SIZE,
            THE-ITEM (SUB-2, SUB-1) DELIMITED BY SIZE,
     INTO DUMMY-REC.
     WRITE PRINT-REC FROM DUMMY-REC.
