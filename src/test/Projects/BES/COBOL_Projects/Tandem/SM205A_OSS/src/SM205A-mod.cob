...
****************************************************************  
*                                                              *  
*    PROGRAM SM205A TESTS THE USE OF THE "COPY" STATEMENT WITH *  
*    ITS "REPLACING" PHRASE FOR A SORT DESCRIPTION AND RELATED *  
*    ENTRIES.  (THIS PROGRAM ASSUMES THAT PROGRAM ST101        *  
*    PERFORMS CORRECTLY).                                      *  
*                                                              *  
****************************************************************  
...
*********************** COPY STATEMENT USED **********************
*                                                                 
*SD  SORTFILE-2E                                       COPY K5SDB 
*                   REPLACING J-RECORD BY S-RECORD.               
*                                                                 
...
*********************** COPY STATEMENT USED **********************
*                                                                 
*01  S-RECORD.                                         COPY K501B 
*             REPLACING KEY-A BY KEY-1                            
*                       XYZ-KEYS BY RDF-KEYS.                     
*                                                                 
******************** COPIED TEXT BEGINS BELOW ********************
 01  S-RECORD.                                         COPY K501B 
              REPLACING KEY-A BY KEY-1                            
...
*        MOVE ZERO TO RECORD-COUNT.                               
 ...
 INSORT SECTION.                                                  
 IN-1.                                                            
*        NOTE TESTS ORDINARY COPYING OF ENTRIES WHICH ARE ALSO    
*             COPIED WITH REPLACEMENT.                            
 IN-2.                                                            
...
*    NOTE HI-LOW CONTROL RECORDS DONE.                            
 ...
 COPY-FAIL-1-4.                                                   
     ...
     PERFORM  FAIL-1.                                             
 COPY-WRITE-4.                                                    
*        NOTE COPYING OF A PROCEDURE WHICH REFERENCES COPIED DATA.
...
*    NOTE     THE FOLLOWING STATEMENTS SHOULD NOT BE EXECUTED.    
     MOVE     RDF-KEYS TO COMPUTED-18V0.                          
