...
*****************************************************************************
 ...
 begin-nested-sub-main-program.
   MOVE 1 to Doo-01 OF Foo-Rec-03.
   MOVE 3 TO Doo-01 OF Foo-Rec-04.
