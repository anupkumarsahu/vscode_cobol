...
const InMemoryCache_SourceScanner: Map<string, cobolSourceScannerInterfaces> = new Map<string, cobolSourceScannerInterfaces>();
...
export class VSCOBOLSourceScanner {
    ...
    public static getCachedObject(document: TextDocument, config: ICOBOLSettings): cobolSourceScannerInterfaces | undefined {
        if (config.enable_source_scanner === false) {
            return undefined;
        }
