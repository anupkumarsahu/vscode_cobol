...
export class VSCOBOLSourceScannerTools {
    ...
    public static getExecTokem(sf: cobolSourceScannerInterfaces, position: Position): COBOLToken|undefined {
    ...
    public static isPositionInEXEC(sf: cobolSourceScannerInterfaces, position: Position): boolean {
