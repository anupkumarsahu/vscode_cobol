...
import { VSCodeSourceHandlerLite } from "../workspace/vscodeSourceHandler";
import { SourceFormat } from "../workspace/sourceformat";
import { TextLanguage, VSExtensionUtils } from "../../utils/extensionUtils";
import { ColourTagHandler } from "./colorComments";
import { fileformatStrategy } from "../../config/IConfiguration";
