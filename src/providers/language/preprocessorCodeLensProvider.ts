...
import { COBOLToken } from "../../features/workspace/cobolsourcescanner";
...
export class VSPPCodeLens implements vscode.CodeLensProvider {
    ...
    public provideCodeLenses(document: vscode.TextDocument, token: vscode.CancellationToken): vscode.ProviderResult<vscode.CodeLens[]> {
        ...
        const current: cobolSourceScannerInterfaces | undefined = VSCOBOLSourceScanner.getCachedObject(document, settings);
