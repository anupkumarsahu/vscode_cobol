...
import { SourceReference_Via_Length, COBOLToken, SharedSourceReferences } from "../../features/workspace/cobolsourcescanner";
...
export { COBOLReferenceProvider as CobolReferenceProvider };
