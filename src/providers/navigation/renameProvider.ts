...
import { COBOLVariable, SharedSourceReferences, SourceReference_Via_Length } from "../../features/workspace/cobolsourcescanner";
...
export { VSCOBOLRenameProvider as VSCobolRenameProvider };
